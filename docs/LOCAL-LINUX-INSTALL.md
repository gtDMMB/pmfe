...
time ./bin/pmfe-parametrizer -v -t 6 -o test_seq/tRNA/o.nivara_tRNA.rnapoly test_seq/tRNA/o.nivara_tRNA.fasta
```
...
```
The wrapper scripts installed to make it easier to run these binaries are installed at the 
following locations:
```bash
ls -l ../../*.sh
```
